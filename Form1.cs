...
namespace RockPaperScissor
{
    public partial class Form1 : Form
    {
        ...
        {
            lblNote.Text = "Number of times you click = Rock Clicks + Paper Clicks + Scissor Clicks";
            lblConsider.Text = "Number of times you click = Your Score + Opponent's Score + Number of times draw";
